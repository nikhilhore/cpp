...
void checkBSTinOrder(BstNode* root);
...
void checkBSTinOrder(BstNode* root){
    if (root==NULL) return;
    checkBSTinOrder(root->left);
    a.push_back(root->data);
    checkBSTinOrder(root->right);
}
/*
	Below function only works with supportive function
		checkBSTinOrder() and vector a declaration.
*/
bool checkBST(BstNode* root){
